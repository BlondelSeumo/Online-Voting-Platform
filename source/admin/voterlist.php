...
<body class="skin-green sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $lang->voter; ?> <?php echo $lang->list; ?></li>
          </ol>
        </section>
		 ...
		 <div class="row">	
		 	<div class="col-md-12">
                ...
                <div class="box-header">
                  <h3 class="box-title"> <?php echo $lang->voter; ?> <?php echo $lang->list; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
				    ...
				    <?php
                     ...
                     if($query->count()) {
					    ...
					    echo '<td><img src="'. $web->url .'source/user/'. $row->imagelocation .'" width="50" height="30" /></td>';
					    ...
					    echo '<td>
		                 ...
		                 <div id="message-action'.$row->userid.'">
					      '.getActions($row->userid, null) .'
					     </div> 
					      <a href="'. $web->url .'admin/editvoter/profile/' . escape($row->userid) . '" class="btn btn-success btn-xs" data-toggle="tooltip" title="' . $lang->edit . '"><span class="fa fa-edit"></span></a>
					      '.getDelete($row->userid) .'
					      </td>';
					    echo '</tr>';
					   }
					}else {
	...
	function doActive(id, state) {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo $web->url; ?>source/admin/template/requests/active.php",
	...
	function delete_the(id) {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo $web->url; ?>source/admin/template/requests/delete.php",
			data: "id="+id, 
			cache: false,
			success: function(html) {
				if(html == '1') {
