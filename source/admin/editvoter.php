...
if ($qs->count() === 1) {
 foreach($qs->results() as $rs) {
  ...
  Redirect::to($web->url.'admin/voterlist');
}	
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $lang->edit; ?> <?php echo $lang->voter; ?></li>
          </ol>
        </section>
        ...
        <section class="content">	 	
		 ...
		 <?php if(isset($imageError)) { //If errors are found ?>
          ...
          <div class="col-lg-4">
          	<?php $selected = (Input::get('m') == 'adminvoterprofile') ? ' active' : ''; ?>
          	<?php $image = (Input::get('m') == 'adminvoterimage') ? ' active' : ''; ?>
          	<?php $active = (Input::get('m') == 'adminvoterpassword') ? ' active' : ''; ?>
	         <div class="list-group">
	         <a href="<?php echo $web->url; ?>admin/editvoter/profile/<?php echo $userid ?>" class="list-group-item<?php echo $selected; ?>">
	          <em class="fa fa-fw fa-user-md text-white"></em>&nbsp;&nbsp;&nbsp;<?php echo $lang->voter; ?> <?php echo $lang->details_details; ?>
			 </a>
	         <a href="<?php echo $web->url; ?>admin/editvoter/image/<?php echo $userid ?>" class="list-group-item<?php echo $image; ?>">
	          <em class="fa fa-fw fa-image text-white"></em>&nbsp;&nbsp;&nbsp;<?php echo $lang->voter; ?> <?php echo $lang->image; ?>
			 </a>
	         <a href="<?php echo $web->url; ?>admin/editvoter/password/<?php echo $userid ?>" class="list-group-item<?php echo $active; ?>">
		 ...
		 <div class="col-lg-8">
		 <?php if (Input::get('m') == 'adminvoterprofile') : ?>
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"><?php echo $lang->edit; ?> <?php echo $lang->voter; ?> <?php echo $lang->details_details; ?></h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post" id="editform"> 
                  <div class="form-group">	
                   <div class="input-group">
                    ...
                    <p class="help-block"><?php echo $lang->voter; ?> <?php echo $lang->name; ?></p>
                  </div>
                  <div class="form-group">	
                   <div class="input-group">
                    ...
                    <p class="help-block"><?php echo $lang->voter; ?> <?php echo $lang->email; ?></p>
                  </div>
                  <div class="form-group">	
                   <div class="input-group">
                    ...
                    <p class="help-block"><?php echo $lang->voter; ?> <?php echo $lang->username; ?></p>
                  </div>      
		 ...
		 <?php elseif (Input::get('m') == 'adminvoterimage') : ?>
                  ...
                  <div class="box-body">
                    <div class="form-group">
					 <div class="image text-center">
					  <img src="<?php 
					  if (isset($_POST['picture'])) {
						 echo $web->url; ?>source/user/<?php echo escape($newname); 
					  } else {
					  echo $web->url; ?>source/user/<?php echo escape($rs->imagelocation); 
		 ...
		 <?php elseif (Input::get('m') == 'adminvoterpassword') : ?>	 
