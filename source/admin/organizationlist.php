...
<body class="skin-green sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $lang->organization; ?> <?php echo $lang->list; ?></li>
          </ol>
        </section>
		 ...
		 <div class="row">	
		 	<div class="col-md-12">
                ...
                <div class="box-header">
                  <h3 class="box-title"> <?php echo $lang->organization; ?> <?php echo $lang->list; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
				    ...
				    <?php
                     ...
                     if($query->count()) {
					    ...
					    echo '<tr id="tr'.$row->organizationid.'">';
					    echo '<td><img src="'. $web->url .'source/admin/'. $row->imagelocation .'" width="50" height="30" /></td>';
					    echo '<td>'. escape($row->name) .'</td>';
					    echo '<td>
					    
					      <a href="'. $web->url .'admin/editorganization/details/' . escape($row->organizationid) . '" class="btn btn-success btn-xs" data-toggle="tooltip" title="' . $lang->edit . '"><span class="fa fa-edit"></span></a>
					      '.getDeleteOrganization($row->organizationid) .'
					      </td>';
					    echo '</tr>';
					   }
					}else {
    ...
    <script type="text/javascript">	
	function delete_the_organization(id) {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo $web->url; ?>source/admin/template/requests/deleteorganization.php",
			data: "id="+id, 
			cache: false,
