	...
	$validation = $validator->check($_POST, [
	  ...
	  if (!$validation->fails()) {
		...
		if (Input::get('user_type') === 'on') {
			 ...
			 if ($login === true) {
	           Redirect::to($web->url.'nominee/dashboard');
			 }else {
			   $hasError = true;
			 }			
		   ...
		   <form method="post">
			...
			<div class="form-foot">
			 <div class="form-actions">					
			  ...
			  <input value="<?php echo $lang->login; ?>" class="kafe-btn kafe-btn-default full-width" type="submit"><br></br>
			  <a href="<?php echo $web->url; ?>register" class="kafe-btn kafe-btn-danger full-width"><?php echo $lang->register; ?></a>
			 </div><!-- /.form-actions -->
             <div class="form-head">
			  <a href="<?php echo $web->url; ?>forgot" class="more-link"><?php echo $lang->forgot; ?> <?php echo $lang->password; ?>?</a>
			 </div>
			</div><!-- /.form-foot -->
		   </form>
